      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center">
        ...
        <div className="flex space-x-12 mt-12 md:mt-0 text-sm">
          <div className="flex flex-col space-y-3">
            <span className="font-semibold text-white uppercase tracking-wider text-xs">Product</span>
            <a href="#" className="text-zinc-400 hover:text-accent transition-colors">Features</a>
            <a href="#" className="text-zinc-400 hover:text-accent transition-colors">Integrations</a>
            <a href="#" className="text-zinc-400 hover:text-accent transition-colors">Pricing</a>
          </div>
          <div className="flex flex-col space-y-3">
            ...
            <a href="#" className="text-zinc-400 hover:text-accent transition-colors">Contact</a>
          </div>
        </div>
      </div>
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-white/10 flex justify-between text-xs text-zinc-400">
