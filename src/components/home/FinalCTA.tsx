      ...
      <div className="max-w-5xl mx-auto px-8 text-center relative z-10">
        ...
        <div className="cta-element flex flex-col sm:flex-row items-center justify-center gap-6">
          <MagneticElement intensity={0.25}>
            <button className="w-full sm:w-auto bg-text text-white px-12 py-5 rounded-full font-bold text-lg hover:bg-accent transition-colors duration-300 shadow-xl shadow-accent/10 hover:shadow-accent/40 hover:-translate-y-1 transform">
              Deploy Your Infrastructure
            </button>
          </MagneticElement>
          
          <MagneticElement intensity={0.15}>
            <a href="#" className="w-full sm:w-auto flex items-center justify-center px-8 py-5 rounded-full font-bold text-lg text-text bg-base border border-gray-200 hover:border-accent hover:text-accent transition-all duration-300">
